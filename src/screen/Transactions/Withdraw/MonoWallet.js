...
React.useLayoutEffect(() => {
  ...
  return (
    ...
    <View style={{marginTop:10,flexDirection:'row', alignItems:'center'}}>
        ...
        <Text family="proximaNovaRegular"  style={{color:"#000000", fontSize:16, lineHeight:30, fontWeight:'400', marginLeft:33}}>Wthdraw to Momo wallet </Text>
