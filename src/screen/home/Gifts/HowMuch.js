...
export default function App(props) {
  ...
  const [stage, setStage] = useState('stageThree')
  ...
  return (
    ...
    >
      ...
      <View style={{marginTop:50, flexDirection:'row', alignItems:'center', justifyContent:'space-between'}}>
        <View style={{width:'80%', height:60, borderRadius:10, backgroundColor:'#FFFFFF', justifyContent:'center'}}>
        <Text  family="proximaNovaRegular"
            style={{
              ...
              marginLeft:12
                 ...
                 Nigeria Netflix Credit Receipt ($10-$1000)
                  </Text>
        </View>

        <View style={{width:64, height:60, borderRadius:10, backgroundColor:'#FFFFFF', justifyContent:'center', alignItems:'center'}}>
        <Text  family="proximaNovaRegular"
            style={{
              color: "#000000",
              fontSize: 14,
