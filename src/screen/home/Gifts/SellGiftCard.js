...
import Redeem from "../../../assets/GiftCardsFolder/Redeem.png";
  ...
  return (
    ...
    >
      ...
      >
       ...
       <Image style={{resizeMode: 'contain', width:"100%" }} source={Redeem} />  
      
       </View>

       <View style={{marginTop:"20%",}}>
               <View style={{marginTop:0,}}>
                  <Text family="proximaNovaSemiBold"  style={{color:'#000000', fontSize:25, lineHeight:35, fontWeight:'700',}}>Redeem gift cards {"\n"}
in one click</Text>
                  <Text family="proximaNovaLight"  style={{color:'#000000', fontSize:14, lineHeight:15, fontWeight:'700',marginBottom:32}}>Get gift cards and vouchers to shop at top brands around the world.</Text>
                  ...
                  <View style={{marginTop:'20%', alignItems:'center', flexDirection:'row', justifyContent:'flex-end', width:'100%'}}>
                    ...
                    <Button 
                      ...
                      onPress={() => {
                       navigation.navigate("GiftCardType")
